**<span style="font-size: 35px;">🧑‍🎄 创建型模式-工厂模式三兄弟</span>**
...
![简单工厂模式结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/2a49e52b-f691-4619-8d26-3de2f625d791_工厂模式结构图.png)
...
![简化的简单工厂模式](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/e0a68b0f-32f5-45ca-86f5-16922ea7bb2c_工厂模式简化.png)
...
![工厂方法模式结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/33b7280b-1301-4275-866f-85a2961d9e1b_工厂方法模式1.png)
...
![抽象工厂模式结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/8fe6342d-4735-4613-845f-d734f3c5c2ed_抽象工厂模式1.png)
...
- [工厂模式三兄弟(Factory Pattern)](https://bytesfly.github.io/blog/#/DesignPattern/factory-pattern?id=工厂模式三兄弟factory-pattern)
