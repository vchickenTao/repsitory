**<span style="font-size: 35px;">🧜 结构型模式-装饰者模式</span>**
...
![装饰模式结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/26733609-11e4-4e8b-8306-f03dba03d833_装饰者模式.png)
...
- [装饰模式(Decorator Pattern)——扩展系统功能](https://bytesfly.github.io/blog/#/DesignPattern/decorator-pattern?id=装饰模式decorator-pattern扩展系统功能)
