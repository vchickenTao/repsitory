**<span style="font-size: 35px;">🧞 结构型模式-享元模式</span>**
...
![字符享元对象示意图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/e762d89d-c020-46c9-857b-902e55f071ec_享元模式概述.png)
...
![享元模式结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/9a05bc61-0135-41cd-8974-f11804abe6a1_享元模式结构图.png)
...
- [享元模式(Flyweight Pattern)——实现对象的复用](https://bytesfly.github.io/blog/#/DesignPattern/flyweight-pattern?id=享元模式flyweight-pattern实现对象的复用)
