**<span style="font-size: 35px;">🦸 创建型模式-原型模式</span>**
...
![原型模式结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/2b28ad06-6af3-4646-8bee-a08687b5c0da_原型模式结构图.png)
...
- [原型模式(Prototype Pattern)——对象的克隆](https://bytesfly.github.io/blog/#/DesignPattern/prototype-pattern?id=原型模式prototype-pattern对象的克隆)
