**<span style="font-size: 35px;">🧙‍♂️ 结构型模式-适配器模式</span>**
...
![对象适配器结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/3ee43e45-9540-4378-8381-29488f041d6c_适配器模式.png)
...
![类适配器结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/dae474ab-5f86-4a25-83d0-b6b109ea9f7b_适配器模式-类适配器.png)
...
![双向适配器结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/76f4a1b7-6941-4db7-8611-75b8d30160d1_双向适配器.png)
...
![缺省适配器结构图](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-18/6c03eeae-6f15-46d8-8bde-42d9401a832b_缺省适配器.png)
...
- [适配器模式(Adapter Pattern)——不兼容结构的协调](https://bytesfly.github.io/blog/#/DesignPattern/adapter-pattern?id=适配器模式adapter-pattern不兼容结构的协调)
