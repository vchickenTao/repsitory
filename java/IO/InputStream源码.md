**<span style="font-size: 35px;">🍋 Java IO  InputStream源码</span>**
...
请参看： [关键字: volatile详解](java/JUC/volatile详解)
...
AtomicReferenceFieldUpdater具体可以参考：[JUC原子类—CAS, Unsafe和原子类详解](java/JUC/CAS,Unsafe和原子类详解)



## 参考文章

- [Java 全栈知识体系](https://www.pdai.tech/md/java/io/java-io-basic-code-inputstream.html)