**<span style="font-size: 35px;">🍢 关键字 synchronized详解</span>**
...
![img](https://pdai.tech/_images/thread/java-thread-x-key-schronized-x1.png)
...
![img](https://pdai.tech/_images/thread/java-thread-x-key-schronized-3.png)
...
![img](https://pdai.tech/_images/thread/java-thread-x-key-schronized-4.png)
...
> `ReentrantLock`为常用类，它是一个可重入的互斥锁 Lock，它具有与使用 synchronized 方法和语句所访问的隐式监视器锁相同的一些基本行为和语义，但功能更强大。详细分析请看: [JUC锁—ReentrantLock详解](java/JUC/JUC锁详解)
...
- 本文转载自[Java 全栈知识体系](https://www.pdai.tech/md/java/thread/java-thread-x-key-synchronized.html)