**<span style="font-size: 35px;">🍚 Java并发 ThreadLocal详解</span>**

---

ThreadLocal简介

我们在[Java 并发—理论基础](java/JUC/并发理论基础)总结过线程安全(是指广义上的共享资源访问安全性，因为线程隔离是通过副本保证本线程访问资源安全性，它不保证线程之间还存在共享关系的狭义上的安全性)的解决思路：
