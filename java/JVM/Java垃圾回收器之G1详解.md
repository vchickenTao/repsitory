**<span style="font-size: 35px;">🎂 GC  Java 垃圾回收器之G1详解</span>**
...
著作权归https://pdai.tech所有。 链接：https://www.pdai.tech/md/java/jvm/java-jvm-gc-g1.html
...
![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/66f017f2-4158-4291-8fa4-8a0b05abcef8_java-jvm-gc-g1-1.jpeg)
...
![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/84f9dc13-6561-4a11-819d-83141a253cfb_java-jvm-gc-g1-2.jpeg)
...
![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/fcd26f74-7ccb-4aab-8c5a-22f6eae6e869_java-jvm-gc-g1-3.jpeg)
...
![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/8cf584e2-8a7e-48cb-840f-0a1bb2a6454d_java-jvm-gc-g1-4.jpeg)
...
#### [¶](#241-年轻代收集集合-cset-of-young-collection) 2.4.1 年轻代收集集合 CSet of Young Collection
...
#### [¶](#242-混合收集集合-cset-of-mixed-collection) 2.4.2 混合收集集合 CSet of Mixed Collection
...
#### [¶](#243-并发标记算法三色标记法) 2.4.3 并发标记算法（三色标记法）

CMS和G1在并发标记时使用的是同一个算法：三色标记法，使用白灰黑三种颜色标记对象。白色是未标记；灰色自身被标记，引用的对象未标记；黑色自身与引用对象都已标记。

![img]( https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/ec232fa6-1d97-4988-8794-5d88036efdda_java-jvm-gc-g1-5.png)
...
![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/85678572-50cb-42ff-8de9-e4022754cfb2_java-jvm-gc-g1-5-1.gif)

#### [¶](#244-漏标问题) 2.4.4 漏标问题

在remark过程中，黑色指向了白色，如果不对黑色重新扫描，则会漏标。会把白色D对象当作没有新引用指向从而回收掉。

![img]( https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/a6abf47f-b7f4-4250-80b5-d66ea682ed9d_java-jvm-gc-g1-6.png)
...
![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/e6743381-5d68-454d-8efa-ad7cce27c3de_java-jvm-gc-g1-7.jpeg)
...
![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/a7818ebd-b8b9-4c1b-8334-3b85d5670efa_java-jvm-gc-g1-8.jpeg)
...
![img]( https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-12/33c08537-7a4b-462d-8937-97e72881cc8c_java-jvm-gc-g1-9.png)
