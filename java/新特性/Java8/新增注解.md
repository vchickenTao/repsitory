...
1. 在java 8之前，注解只能是在声明的地方所使用，比如`类`，`方法`，`属性`；
2. java 8里面，注解可以应用在**任何地方**，比如:
...
- [Java 全栈知识体系 - Java8 类型注解](https://www.pdai.tech/md/java/java8/java8-anno-repeat.html)
- [Java 全栈知识体系- Java8 重复注解](https://www.pdai.tech/md/java/java8/java8-type-anno.html)
