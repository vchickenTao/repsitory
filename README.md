...
## 🍵 面向对象及基础
   ...
   - [Java基础 - 接口详解](java/面向对象及基础/接口详解)
   - [Java基础 - 反射详解](java/面向对象及基础/反射详解)
...
## 💡 NOSQL数据库
   ...
   - [Redis](database/Redis)
     ...
     - [Redis入门 - Redis数据类型](database/Redis/Redis数据类型)
     - [Redis入门 - 3种特殊类型](database/Redis/3种特殊类型)
     - [Redis入门 - Stream结构详解](database/Redis/Stream结构详解)
     - [Redis进阶 - 对象机制详解](https://www.pdai.tech/md/db/nosql-redis/db-redis-x-redis-object.html)
     - [Redis进阶 - 底层数据结构详解](https://www.pdai.tech/md/db/nosql-redis/db-redis-x-redis-ds.html)
     - [Redis进阶 - 持久化之RDB和AOF](https://www.pdai.tech/md/db/nosql-redis/db-redis-x-rdb-aof.html)
     - [Redis进阶 - 发布和订阅模式](https://www.pdai.tech/md/db/nosql-redis/db-redis-x-pub-sub.html)
     - [Redis进阶 - 事件机制详解](https://www.pdai.tech/md/db/nosql-redis/db-redis-x-event.html)
     - [Redis进阶 - 事务详解及案例](database/Redis/事务详解及案例)
     - [Redis进阶 - 主从复制](database/Redis/主从复制)
     - [Redis进阶 - 哨兵机制](https://www.pdai.tech/md/db/nosql-redis/db-redis-x-sentinel.html)
     - [Redis进阶 - Cluster集群](database/Redis/Cluster集群)
     - [Redis进阶 - 缓存穿透等应用问题解决](database/Redis/缓存穿透等应用问题解决)
     - [Redis进阶 - Redis主要版本特性](database/Redis/Redis主要版本特性)
     - [Redis进阶 - Redis的监控详解](database/Redis/Redis的监控详解)
     - [Redis进阶 - 性能调优详解](database/Redis/性能调优详解)
     - [Redis进阶 - Redis大型实战](database/Redis/Redis大型实战)
...
## 🍄 设计模式
   - 设计模式
     ...
     - 创建型模式
       - [工厂模式三兄弟(Factory Pattern)](design/设计模式/工厂模式三兄弟)
       - [单例模式(Singleton Pattern)](design/设计模式/单例模式)
       - [原型模式(Prototype Pattern)](design/设计模式/原型模式)
       - [建造者模式(Builder Pattern)](design/设计模式/建造者模式)
     - 结构型模式
       - [适配器模式(Adapter Pattern)](design/设计模式/适配器模式)
       - [桥接模式(Bridge Pattern)](design/设计模式/桥接模式)
       - [组合模式(Composite Pattern)](design/设计模式/组合模式)
       - [装饰模式(Decorator Pattern)](design/设计模式/装饰模式)
       - [外观模式(Facade Pattern)](design/设计模式/外观模式)
       - [享元模式(Flyweight Pattern)](design/设计模式/享元模式)
       - [代理模式(Proxy Pattern)](design/设计模式/代理模式)
     - 行为型模式
       - [职责链模式(Chain of Responsibility Pattern)](design/设计模式/职责链模式)
       - [命令模式(Command Pattern)](design/设计模式/命令模式)
       - [解释器模式(Interpreter Pattern)](design/设计模式/解释器模式)
       - [迭代器模式(Iterator Pattern)](design/设计模式/迭代器模式)
       - [中介者模式(Mediator Pattern)](design/设计模式/中介者模式)
       - [备忘录模式(Memento Pattern)](design/设计模式/备忘录模式)
       - [观察者模式(Observer Pattern)](design/设计模式/观察者模式)
       - [访问者模式(visitor pattern)](design/设计模式/访问者模式)
       - [状态模式(State Pattern)](design/设计模式/状态模式)
       - [策略模式(Strategy Pattern)](design/设计模式/策略模式)
       - [模板方法模式(Template Method Pattern)](design/设计模式/模板方法模式)
