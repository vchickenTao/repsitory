**<span style="font-size: 35px;">🐊 MySQL索引进阶 - InnoDB数据存储结构</span>**
...
![img](MySQL索引及调优篇.assets/image-20220617175755324.png)

### 1.1 磁盘与内存交互基本单位：页

![img](MySQL索引及调优篇.assets/image-20220617193033971.png) 

![image-20220617193939742](MySQL索引及调优篇.assets/image-20220617193939742.png)

### 1.2 页结构概述

![img](MySQL索引及调优篇.assets/image-20220617193218557.png)
...
![img](MySQL索引及调优篇.assets/image-20220617194529699.png)
...
![img](MySQL索引及调优篇.assets/image-20220620221242561.png)

![img](MySQL索引及调优篇.assets/image-20220620221442954.png) 
...
![img](MySQL索引及调优篇.assets/image-20220621134226624.png)

### 4.2 为什么要有段？

![img](MySQL索引及调优篇.assets/image-20220621140802887.png)

### 4.3 为什么要有碎片区？

![img](MySQL索引及调优篇.assets/image-20220621141225223.png)
...
![img](MySQL索引及调优篇.assets/image-20220621142910222.png)
...
![img](MySQL索引及调优篇.assets/image-20220621150648770.png) 
...
![img](MySQL索引及调优篇.assets/image-20220621150924922.png) 
...
![img](MySQL索引及调优篇.assets/image-20220621151139759.png) 

![img](MySQL索引及调优篇.assets/image-20220621151158361.png)

![img](MySQL索引及调优篇.assets/image-20220621151215274.png)

![img](MySQL索引及调优篇.assets/image-20220621151238157.png)
...
![img](MySQL索引及调优篇.assets/image-20220621135719847.png)

![image-20220621135737422](MySQL索引及调优篇.assets/image-20220621135737422.png)

**3. 顺序读取**

![img](MySQL索引及调优篇.assets/image-20220621135909197.png)
