**<span style="font-size: 35px;">🐊 MySQL索引进阶 - 性能分析工具的使用</span>**
...
![img](MySQL索引及调优篇.assets/image-20220627164046438.png)

![img](MySQL索引及调优篇.assets/image-20220627164114562.png)
...
![img](MySQL索引及调优篇.assets/image-20220628173022699.png)
...
![img](MySQL索引及调优篇.assets/image-20220628173525966.png)
...
![img](MySQL索引及调优篇.assets/image-20220628175226812.png)
...
![img](MySQL索引及调优篇.assets/image-20220628175353233.png)
...
![img](MySQL索引及调优篇.assets/image-20220628175425922.png)
...
![img](MySQL索引及调优篇.assets/image-20220628195650079.png)
...
![img](MySQL索引及调优篇.assets/image-20220628195821440.png)
...
![img](MySQL索引及调优篇.assets/image-20220628203545536.png)
...
![img](MySQL索引及调优篇.assets/image-20220628204922556.png)
...
![img](MySQL索引及调优篇.assets/image-20220628205029208.png)
...
![img](MySQL索引及调优篇.assets/image-20220628205243769.png)
...
![img](MySQL索引及调优篇.assets/image-20220628205317257.png)

```mysql
mysql> show profile cpu,block io for query 2
```

![img](MySQL索引及调优篇.assets/image-20220628205354230.png)
...
![img](MySQL索引及调优篇.assets/image-20220628210837301.png)
...
![img](MySQL索引及调优篇.assets/image-20220628211351678.png)
...
![img](MySQL索引及调优篇.assets/image-20220628212029574.png)
...
![img](MySQL索引及调优篇.assets/image-20220628221948512.png)
...
![img](MySQL索引及调优篇.assets/image-20220629170848349.png)
...
![img](MySQL索引及调优篇.assets/image-20220629171104375.png) 
...
![img](MySQL索引及调优篇.assets/image-20220629171611716.png)
...
![img](MySQL索引及调优篇.assets/image-20220629190304966.png)
...
![img](MySQL索引及调优篇.assets/image-20220629190335371.png)
...
* `system`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220630164434315.png)
...
* `const`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220630164724548.png)
...
* `eq_ref`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220630164802559.png)
...
* `ref`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220630164930020.png)
...
* `ref_or_null`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220630175133920.png)
...
* `index_merge`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220630175511644.png)
...
* `unique_subquery`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220630180123913.png) 
...
![img](MySQL索引及调优篇.assets/image-20220704131759630.png)
...
* `Using where`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220704140148163.png)
  ...
  ![img](MySQL索引及调优篇.assets/image-20220704140212813.png)
...
* `Using index condition`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220704140344015.png)

  ![img](MySQL索引及调优篇.assets/image-20220704140411033.png)
...
* `Using filesort`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220704145143170.png)
...
* `Using temporary`
  ...
  ![img](MySQL索引及调优篇.assets/image-20220704145924130.png)
...
![img](MySQL索引及调优篇.assets/image-20220704175711800.png)
...
![img](MySQL索引及调优篇.assets/image-20220704190726180.png)
...
![img](MySQL索引及调优篇.assets/image-20220704192020603.png)
