**<span style="font-size: 35px;">🐊 MySQL索引进阶 - 索引优化与查询优化</span>**
...
![img](MySQL索引及调优篇.assets/image-20220704202453482.png)
...
![img](MySQL索引及调优篇.assets/image-20220704204140589.png)
...
![img](MySQL索引及调优篇.assets/image-20220704212354041.png)
...
![img](MySQL索引及调优篇.assets/image-20220705173047234.png)
...
![img](MySQL索引及调优篇.assets/image-20220705220033520.png) 

**过程四：order by 时规则不一致，索引失效（顺序错，不索引；方向反，不索引）**

![img](MySQL索引及调优篇.assets/image-20220705220404802.png)

> 结论：ORDER BY 子句，尽量使用 Index 方式排序，避免使用 FileSort 方式排序

**过程五：无过滤，不索引**

![img](MySQL索引及调优篇.assets/image-20220705221212879.png)
...
![img](MySQL索引及调优篇.assets/image-20220705222954971.png)
...
![img](MySQL索引及调优篇.assets/image-20220705223329164.png)
...
![img](MySQL索引及调优篇.assets/image-20220705224410340.png)

**2. 尝试提高 max_length_for_sort_data**

![img](MySQL索引及调优篇.assets/image-20220705224505668.png)

**3. Order by 时select * 是一个大忌。最好只Query需要的字段。**

![img](MySQL索引及调优篇.assets/image-20220705224551104.png)
...
![img](MySQL索引及调优篇.assets/image-20220705225329130.png)
...
![img](MySQL索引及调优篇.assets/image-20220706125943936.png) 
...
![img](MySQL索引及调优篇.assets/image-20220706130921934.png) 
...
![img](MySQL索引及调优篇.assets/image-20220706131320477.png)
...
![img](MySQL索引及调优篇.assets/image-20220706135436316.png)

![img](MySQL索引及调优篇.assets/image-20220706135506409.png)
...
![img](MySQL索引及调优篇.assets/image-20220706135723203.png)

### 10.4 开启和关闭ICP性能对比

![img](MySQL索引及调优篇.assets/image-20220706135904713.png)

![img](MySQL索引及调优篇.assets/image-20220706140213382.png)
...
![img](MySQL索引及调优篇.assets/image-20220706141957185.png)
...
![img](MySQL索引及调优篇.assets/image-20220706142648452.png)
...
![img](MySQL索引及调优篇.assets/image-20220706162947613.png)
