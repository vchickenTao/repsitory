...
![img](MySQL索引及调优篇.assets/image-20220707200915836.png)

如何确定呢？一般情况下，有如下几种方式：

![img](MySQL索引及调优篇.assets/image-20220707201133424.png)
...
![img](MySQL索引及调优篇.assets/image-20220707201443229.png)

#### 第2步：优化表设计

![img](MySQL索引及调优篇.assets/image-20220707201617799.png)

#### 第3步：优化逻辑查询

![img](MySQL索引及调优篇.assets/image-20220707202059972.png)

#### 第4步：优化物理查询

物理查询优化是在确定了逻辑查询优化之后，采用物理优化技术（比如索引等），通过计算代价模型对 各种可能的访问路径进行估算，从而找到执行方式中代价最小的作为执行计划。**在这个部分中，我们需要掌握的重点是对索引的创建和使用。**

![img](MySQL索引及调优篇.assets/image-20220707202156660.png)
...
![img](MySQL索引及调优篇.assets/image-20220707202436467.png)

#### 第6步：库级优化

![img](MySQL索引及调优篇.assets/image-20220707202555506.png)

![img](MySQL索引及调优篇.assets/image-20220707202732911.png)

![img](MySQL索引及调优篇.assets/image-20220707203538155.png)

![img](MySQL索引及调优篇.assets/image-20220707203607993.png)

> 但需要注意的是，分拆在提升数据库性能的同时，也会增加维护和使用成本。

## 2. 优化MySQL服务器

![img](MySQL索引及调优篇.assets/image-20220707203818987.png)
...
![img](MySQL索引及调优篇.assets/image-20220707204403406.png)
...
![img](MySQL索引及调优篇.assets/image-20220707210351452.png)

**(1) 调整系统参数 InnoDB_flush_log_at_trx_commit**

![img](MySQL索引及调优篇.assets/image-20220707210447501.png)

**(2)  调整系统参数 InnoDB_buffer_pool_size**

![img](MySQL索引及调优篇.assets/image-20220707210555848.png)

**(3) 调整系统参数 InnoDB_buffer_pool_instances**

![img](MySQL索引及调优篇.assets/image-20220707210720394.png)

## 3. 优化数据库结构

![img](MySQL索引及调优篇.assets/image-20220707211709553.png)

### 3.1 拆分表：冷热数据分离

![img](MySQL索引及调优篇.assets/image-20220707211802756.png)
...
![img](MySQL索引及调优篇.assets/image-20220707212800544.png)
...
![img](MySQL索引及调优篇.assets/image-20220707213524137.png)
...
![img](MySQL索引及调优篇.assets/image-20220707214640374.png)
...
![img](MySQL索引及调优篇.assets/image-20220707215305640.png)

**② 禁用唯一性检查**

![img](MySQL索引及调优篇.assets/image-20220707215356893.png)
...
![img](MySQL索引及调优篇.assets/image-20220707220034534.png)

**③ 禁止自动提交**

![img](MySQL索引及调优篇.assets/image-20220707220131891.png)

### 3.6 使用非空约束

![img](MySQL索引及调优篇.assets/image-20220707220157606.png)
...
![img](MySQL索引及调优篇.assets/image-20220707222156765.png)

**方式二：使用mysqlcheck命令**

![img](MySQL索引及调优篇.assets/image-20220707222305302.png)
...
![img](MySQL索引及调优篇.assets/image-20220707222954304.png)

![image-20220707222739120](MySQL索引及调优篇.assets/image-20220707222739120.png)

![img](MySQL索引及调优篇.assets/image-20220707223024163.png)
...
![img](MySQL索引及调优篇.assets/image-20220707223246684.png)

![img](MySQL索引及调优篇.assets/image-20220707223349879.png)

### 5.3 MySQL 8.0新特性：隐藏索引对调优的帮助

![img](MySQL索引及调优篇.assets/image-20220707223420496.png)
