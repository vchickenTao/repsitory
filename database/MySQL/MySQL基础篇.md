...
> [!TIP]
>
> 以下是学习使用的表结构及测试数据,读者可自行导入到自己的数据库中，以便后面的学习，边理论边实践，加深理解。@vchicken
...
![](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-15/eb90f280-d36e-4514-8277-4c7cae2e1428_外键约束问题.png)
