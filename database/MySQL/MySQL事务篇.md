...
* **提交的（committed）**
  ...
  ![img](MySQL事物篇.assets/image-20220708171859055.png)
...
![img](MySQL事物篇.assets/image-20220708201221316.png)
...
![img](MySQL事物篇.assets/image-20220708220228436.png)
...
![img](MySQL事物篇.assets/image-20220708220957108.png)

### 3.4 MySQL支持的四种隔离级别

![img](MySQL事物篇.assets/image-20220708221639979.png)
...
![img](MySQL事物篇.assets/image-20220708223250773.png)
...
![img](MySQL事物篇.assets/image-20220710194612317.png)
...
![img](MySQL事物篇.assets/image-20220710205948156.png)
...
![img](MySQL事物篇.assets/image-20220710210751414.png)

![img](MySQL事物篇.assets/image-20220710211318120.png)

![img](MySQL事物篇.assets/image-20220710211335379.png)

![img](MySQL事物篇.assets/image-20220710211618789.png)

![img](MySQL事物篇.assets/image-20220710211831675.png) 

![img](MySQL事物篇.assets/image-20220710212041563.png)
...
![img](MySQL事物篇.assets/image-20220710215001482.png)
...
![img](MySQL事物篇.assets/image-20220710215353893.png)
...
![img](MySQL事物篇.assets/image-20220710220838744.png)

![image-20220710220919271](MySQL事物篇.assets/image-20220710220919271.png)

![img](MySQL事物篇.assets/image-20220710221221981.png)
...
![img](MySQL事物篇.assets/image-20220710223117420.png)
...
![img](MySQL事物篇.assets/image-20220711144608223.png)
...
![](MySQL事物篇.assets/image-20220711152137012.png)
...
![img](MySQL事物篇.assets/image-20220711152631108.png)

如果 write pos 追上 checkpoint ，表示`日志文件组`满了，这时候不能再写入新的 redo log记录，MySQL 得 停下来，清空一些记录，把 checkpoint 推进一下。

![img](MySQL事物篇.assets/image-20220711152802294.png)

### 1.9 redo log 小结

![img](MySQL事物篇.assets/image-20220711152930911.png)
...
![img](MySQL事物篇.assets/image-20220711153523704.png)

### 2.2 Undo日志的作用

* **作用1：回滚数据**

![img](MySQL事物篇.assets/image-20220711153645204.png)
...
![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-16/e2edb856-1e04-4bca-8fcf-3a4374edac21_image-20220711154936382.png)

![img](https://vue-admin-imgages.oss-cn-hangzhou.aliyuncs.com/2022-09-16/861f1b6c-dade-40ab-8bae-0e0fc82ad38e_image-20220711155044078.png)
...
![img](MySQL事物篇.assets/image-20220711162414928.png)
...
![img](MySQL事物篇.assets/image-20220711162919157.png)
...
![img](MySQL事物篇.assets/image-20220711165954976.png)
...
![img](MySQL事物篇.assets/image-20220711202206405.png)
...
![img](MySQL事物篇.assets/image-20220711203250284.png)
...
![img](MySQL事物篇.assets/image-20220711203723941.png)
...
![img](MySQL事物篇.assets/image-20220711204843684.png)

#### 1. 锁定读

![img](MySQL事物篇.assets/image-20220711212931912.png)

![img](MySQL事物篇.assets/image-20220711213741630.png)

![img](MySQL事物篇.assets/image-20220711214013208.png)

#### 2. 写操作

![img](MySQL事物篇.assets/image-20220711214412163.png)

### 3.2 从数据操作的粒度划分：表级锁、页级锁、行锁

![img](MySQL事物篇.assets/image-20220711214719510.png)

#### 1. 表锁（Table Lock）

![img](MySQL事物篇.assets/image-20220711214805088.png)
...
![img](MySQL事物篇.assets/image-20220711220342251.png)

或者

![img](MySQL事物篇.assets/image-20220711220418859.png)
...
![img](MySQL事物篇.assets/image-20220711220442269.png)
...
![img](MySQL事物篇.assets/image-20220711220502141.png)
...
![img](MySQL事物篇.assets/image-20220711222132300.png)
...
![img](MySQL事物篇.assets/image-20220712124209006.png)
...
![img](MySQL事物篇.assets/image-20220712175552985.png)
...
![img](MySQL事物篇.assets/image-20220713143156759.png)
...
![img](MySQL事物篇.assets/image-20220713161549241.png)
...
![img](MySQL事物篇.assets/image-20220713174726264.png)
...
![img](MySQL事物篇.assets/image-20220713175032619.png) 

![img](MySQL事物篇.assets/image-20220713192418730.png)
...
![img](MySQL事物篇.assets/image-20220713203124889.png)

![img](MySQL事物篇.assets/image-20220713203532124.png)

![img](MySQL事物篇.assets/image-20220713203619704.png)

![img](MySQL事物篇.assets/image-20220713203714577.png)
...
![img](MySQL事物篇.assets/image-20220713204544767.png)

![img](MySQL事物篇.assets/image-20220713205010502.png)

![img](MySQL事物篇.assets/image-20220713205135694.png)
...
![img](MySQL事物篇.assets/image-20220713210951100.png)

![img](MySQL事物篇.assets/image-20220713211139670.png)
...
![img](MySQL事物篇.assets/image-20220713211417909.png)

### 3.4 按加锁的方式划分：显式锁、隐式锁

#### 1. 隐式锁

![img](MySQL事物篇.assets/image-20220713211525845.png)
...
![img](MySQL事物篇.assets/image-20220713214522709.png)
...
![img](MySQL事物篇.assets/image-20220713220936236.png)
...
![img](MySQL事物篇.assets/image-20220713221418100.png)
...
![img](MySQL事物篇.assets/image-20220714131008260.png)
...
![img](MySQL事物篇.assets/image-20220714140510426.png)
...
![img](MySQL事物篇.assets/image-20220714140716427.png)
...
![img](MySQL事物篇.assets/image-20220714140908661.png)
...
![img](MySQL事物篇.assets/image-20220714141154235.png)
...
![img](MySQL事物篇.assets/image-20220714142254768.png)
...
![img](MySQL事物篇.assets/image-20220715130639408.png)
...
![img](MySQL事物篇.assets/image-20220715131200077.png)
...
![img](MySQL事物篇.assets/image-20220715134540737.png)
...
![img](MySQL事物篇.assets/image-20220715135017000.png)

![img](MySQL事物篇.assets/image-20220715135143939.png)
...
![img](MySQL事物篇.assets/image-20220715140155744.png)
...
![img](MySQL事物篇.assets/image-20220715140555172.png)

![img](MySQL事物篇.assets/image-20220715140620328.png)
...
![img](MySQL事物篇.assets/image-20220715141002035.png)
...
![img](MySQL事物篇.assets/image-20220715141413135.png)

通过MVCC我们可以解决：

![img](MySQL事物篇.assets/image-20220715141515370.png) 
