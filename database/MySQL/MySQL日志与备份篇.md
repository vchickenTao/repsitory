...
![img](MySQL日志与备份篇.assets/image-20220715141705004.png)
...
![img](MySQL日志与备份篇.assets/image-20220715145650406.png)
...
![img](MySQL日志与备份篇.assets/image-20220715155010381.png)
...
![img](MySQL日志与备份篇.assets/image-20220715160249271.png)
...
![img](MySQL日志与备份篇.assets/image-20220715160657093.png)
...
![img](MySQL日志与备份篇.assets/image-20220715161216556.png)

### 4.4 MySQL 8.0 新特性

![img](MySQL日志与备份篇.assets/image-20220715161321565.png)
...
binlog主要应用场景：
  ...
  ![img](MySQL日志与备份篇.assets/image-20220715161800635.png)
...
![img](MySQL日志与备份篇.assets/image-20220715163520596.png)
...
![img](MySQL日志与备份篇.assets/image-20220715163811664.png)
...
![img](MySQL日志与备份篇.assets/image-20220715164107352.png)
...
![img](MySQL日志与备份篇.assets/image-20220715164718970.png)

![img](MySQL日志与备份篇.assets/image-20220715164743351.png)

![img](MySQL日志与备份篇.assets/image-20220715164809401.png)
...
![img](MySQL日志与备份篇.assets/image-20220715165603879.png)
...
![img](MySQL日志与备份篇.assets/image-20220715171712026.png)

![img](MySQL日志与备份篇.assets/image-20220715172015185.png)

**2. RESET MASTER: 删除所有二进制日志文件**

![img](MySQL日志与备份篇.assets/image-20220715172104967.png)
...
![img](MySQL日志与备份篇.assets/image-20220715214055057.png)
...
![img](MySQL日志与备份篇.assets/image-20220718142045114.png)
...
![img](MySQL日志与备份篇.assets/image-20220718144051094.png)
...
![img](MySQL日志与备份篇.assets/image-20220718144926758.png)
...
![img](MySQL日志与备份篇.assets/image-20220718145936444.png)
...
![img](MySQL日志与备份篇.assets/image-20220718163627669.png)
...
![img](MySQL日志与备份篇.assets/image-20220718165738367.png)

### 8.1 delete：误删行

![img](MySQL日志与备份篇.assets/image-20220718165909464.png)

### 8.2 truncate/drop ：误删库/表

![img](MySQL日志与备份篇.assets/image-20220718170026929.png)

### 8.3 预防使用truncate/drop误删库/表

![img](MySQL日志与备份篇.assets/image-20220718170132339.png)

![img](MySQL日志与备份篇.assets/image-20220718170215247.png)
